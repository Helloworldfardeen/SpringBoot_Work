 ...
 *         in Java applications. It allows us to access and persist data between
 *         Java object/ class and relational database. JPA follows
 *         Object-Relation Mapping (ORM). It is a set of interfaces. It also
 *         provides a runtime EntityManager API for processing queries and
 *         transactions on the objects against the database. It uses a
 *         platform-independent object-oriented query language JPQL (Java
 *         Persistent Query Language). JPA is implemented with Annotations
 */
/*
